...
export default function AdminProjects() {
    ...
    const handleRejectConfirm = (projectId, reason) => {
        console.log(`Проект ${projectId} отклонен. Причина: ${reason}`);
        // Здесь будет логика отклонения проекта
                    ...
                    {projects.map((project, idx) => (
                        <div key={idx} className="flex flex-col border-[1.5px] border-(--color-gray-plus-50) rounded-[1rem] gap-[1rem] p-[1.25rem]">
                            ...
                            <div className="flex justify-end gap-[0.5rem]">
                                <Button inverted roundeful className={`!w-fit reject-button`} onClick={() => handleRejectClick(project.id)}>
                                    Отклонить <Zapret />
                                </Button>
                                ...
                                return (
                                    <>
                                        ...
                                        <div className="flex gap-[.5rem]">
                                            <Button
                                                className="reject-button nh"
                                                onClick={() => {
                                                    handleRejectClick(selectedProject);
                                                }}>
                                                Отклонить <Zapret />
                                            </Button>
