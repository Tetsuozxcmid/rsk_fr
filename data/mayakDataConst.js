export const STATIC_MAYAK_DATA = {
    "fieldsList": [
      {
        "code": "m",
        "label": "М - Миссия. Что сделать?"
      },
      {
        "code": "a",
        "label": "А - Аудитория. Для кого?"
      },
      {
        "code": "y",
        "label": "Я - Роль. Какой эксперт лучше всего это сделает?"
      },
      {
        "code": "k",
        "label": "К - Критерии. Какие прилагательные успеха?"
      },
      {
        "code": "o1",
        "label": "О - Ограничения. Количество и что важно отметить?"
      },
      {
        "code": "k2",
        "label": "К - Контекст. Как и где будет использоваться?"
      },
      {
        "code": "o2",
        "label": "О - Оформление. Как оформить результат?"
      }
    ],
    "defaultTypes": [
      {
    ...
    "synonyms": {
      "imagine": [
        "Представь, что ты",
        "Вообрази себя в роли",
        "Допустим, что ты сейчас —",
        "Поставь себя на место"
      ],
      "isKnown": [
        "и ты известен тем, что отлично справляешься с",
        "который славится мастерством в",
        "известный своими умениями в области",
        "чьим главным преимуществом является"
      ],
      "needTo": [
        "Теперь тебе необходимо",
        "Твоя задача —",
        "Требуется",
        "Следует"
      ],
      "forAudience": [
        "для аудитории",
        "с учётом интересов целевой группы",
        "чтобы охватить сегмент",
        "желая донести идею до"
      ],
      "withLimit": [
        "учитывая следующие ограничения:",
        "при этом помня о таких условиях:",
        "не забывая о правилах:",
        "соблюдая важные требования:"
      ],
      "inContext": [
        "и использовать это в контексте",
        "для дальнейшего применения в",
        "чтобы внедрить это в",
        "с прицелом на"
      ],
      "finalFormat": [
        "оформи всё в виде",
        "представь окончательный результат как",
        "заверши работу форматом",
        "приведи к формату"
      ]
    },
    "contentTypePlaceholders": {
      "misc": {
        "m": "Какую задачу с файлом решить? (напр., конвертировать, извлечь текст)",
        "a": "Кто будет использовать результат? (напр., коллега, клиент)",
        "y": "Какой специалист это делает? (напр., ассистент, аналитик)",
        "k": "Какие качества важны? (напр., точность, скорость, сохранение формата)",
        "o1": "Какие есть ограничения? (напр., плохое качество, защита файла)",
        "k2": "Где будет применяться результат? (напр., в отчете, для отправки по почте)",
        "o2": "В каком виде предоставить итог? (напр., .docx файл, .zip архив)"
      }
    },
    "contentTypeOptions": {
      "text": {
      ...
      "misc": {
        "mission": [
          "Автоматизировать рутинную задачу по обработке цифрового файла",
          "Преобразовать информацию из одного формата в другой для дальнейшей работы",
          "Извлечь ключевые данные из документа для анализа или архивации",
          "Оптимизировать файл, уменьшив его размер без потери важной информации"
        ],
        "audience": [
          "сотрудник, работающий с большим объемом документов",
          "специалист, которому нужно подготовить данные для отчета",
          "исследователь, собирающий информацию из разных источников",
          "обычный пользователь, которому нужно решить быструю техническую задачу"
        ],
        "role": [
          "специалист по автоматизации рабочих процессов",
          "технический ассистент, выполняющий задачи по обработке данных",
          "цифровой архивариус, систематизирующий информацию",
          "эксперт по работе с различными форматами файлов"
        ],
        "criteria": [
          "максимальная точность и соответствие исходным данным",
          "сохранение исходной структуры и форматирования, где это возможно",
          "высокая скорость выполнения операции",
          "минимальная потребность в последующих ручных правках"
        ],
        "limitations": [
          "исходный файл имеет низкое качество или содержит повреждения",
          "документ защищен от копирования или редактирования",
          "присутствуют нестандартные шрифты или сложные элементы форматирования",
          "большой объем исходных данных, требующий оптимизации процесса"
        ],
        "context": [
          "оптимизация внутреннего документооборота в компании",
          "подготовка материалов для последующего анализа или публикации",
          "создание удобного цифрового архива из бумажных или неудобных форматов",
          "упрощение обмена файлами по электронной почте или в мессенджерах"
        ],
        "format": [
          "готовый файл в указанном формате (например, .docx, .xlsx, .txt)",
          "структурированный текстовый документ с извлеченными данными",
          "оптимизированная версия исходного файла",
          "архив с результатами обработки"
        ]
      }
    }
  };